        ...
        <div class="css-ffnekd">
            <div class="css-1nn2x58">
                <div class="css-97cyn8">
                    <div class="css-3r5h64">
                        <div class="css-k0nmra">
                            ...
                            <div class="css-porh3">
                                <h3 data-id="lblProfileName">Data Penerimaan</h3>
                            </div>
                ...
                <div class="css-1bo6mi5">
                    <a href="<?= site_url('laporan/penerimaan/cetak') ?>" target="_blank" class="css-w954na-unf-btn e1ggruw00"><span>Lihat Laporan</span></a>
                </div>
            </div>
        </div>
        <div class="css-ffnekd">
                ...
                <div class="css-97cyn8">
                    <div class="css-3r5h64">
                        <div class="css-k0nmra">
                            <img class="css-mnywuz" src="<?= assets() ?>images/report.png">
                            <div class="css-porh3">
                                <h3 data-id="lblProfileName">Penerimaan Perperiode</h3>
                            </div>
                            <div class="css-1bmrgqt"></div>
                        </div>
                    </div>
                ...
                <div class="css-97cyn8">
                    <div class="css-3r5h64">
                        <div class="css-k0nmra">
                            <img class="css-mnywuz" src="<?= assets() ?>images/report.png">
                            <div class="css-porh3">
                                <h3 data-id="lblProfileName">Penerimaan Perbulan</h3>
                            </div>
                            <div class="css-1bmrgqt"></div>
                        </div>
                    </div>
                ...
                <div class="css-97cyn8">
                    <div class="css-3r5h64">
                        <div class="css-k0nmra">
                            <img class="css-mnywuz" src="<?= assets() ?>images/report.png">
                            <div class="css-porh3">
                                <h3 data-id="lblProfileName">Penerimaan Pertahun</h3>
                            </div>
                            <div class="css-1bmrgqt"></div>
                        </div>
                    </div>
...
<script>
    function modal_perperiode() {
        $.ajax({
            url: "<?= site_url('laporan/penerimaan/modal_perperiode') ?>",
            type: "GET",
    ...
    function modal_perbulan() {
        $.ajax({
            url: "<?= site_url('laporan/penerimaan/modal_perbulan') ?>",
            type: "GET",
            success: function(resp) {
                $("#tampil_modal").html(resp);
                $("#modal_report").modal('show');
    ...
    function modal_pertahun() {
        $.ajax({
            url: "<?= site_url('laporan/penerimaan/modal_pertahun') ?>",
            type: "GET",
            success: function(resp) {
                $("#tampil_modal").html(resp);
                $("#modal_report").modal('show');
