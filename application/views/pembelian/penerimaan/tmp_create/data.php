...
?>
        <tr>
            ...
            <td class="text-center">
                <a href="javascript:void(0)" onclick="edit('<?= $d['iddetail'] ?>')"><i class="icon-pencil7 text-green" title="Edit Data"></i></a>
                <a href="javascript:void(0)" onclick="destroy('<?= $d['iddetail'] ?>')"><i class="icon-trash text-red" title="Hapus Data"></i></a>
            </td>
        </tr>
    <?php $no++;
    } ?>
