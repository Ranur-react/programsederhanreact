        ...
        <div class="row">
            <div class="col-lg-12 col-xs-12 ">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-xs-8"><?= currency($data['harga_minta']) ?></div>
                    <div class="col-lg-2 col-xs-4"><b>Jumlah</b> <span class="value">:</span></div>
                    <div class="col-lg-10 col-xs-8"><?= number_decimal($data['jumlah_minta']) . ' ' . $data['singkatan_satuan'] ?></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="form-group">
    ...
    <input type="text" name="harga" id="harga" class="form-control" placeholder="Harga" value="<?= number_decimal($data['harga_terima']) ?>" autocomplete="off">
</div>
<div class="form-group">
    <label class="required">Jumlah</label>
    <input type="text" name="jumlah" id="jumlah" class="form-control" placeholder="Jumlah" value="<?= number_decimal($data['jumlah_terima']) ?>" autocomplete="off">
</div>
<script>
    $(function() {
